...
![](images/e827fee515c170aa5bc1f27649ee617da3fddb7749ab701a4ceac62da91aaa82.jpg)
...
graph LR
  ...
  NSP["NSP"] --> MaskLM["Mask LM"]
  MaskLM --> MaskLM["Mask LM"]
  MaskLM --> C["C"]
  MaskLM --> T1["T₁"]
  MaskLM --> TN["TN"]
  MaskLM --> T(SEP)[T(SEP)]
  ...
  BERT --> EM["EM'"]
  E["CLS"] --> Tok1["Tok 1"]
  Tok1 --> MaskA["Masked Sentence A"]
  MaskA --> Unlabeled["Unlabeled Sentence A and B Pair"]
  TokN["Tok N"] --> MaskB["Masked Sentence B"]
  MaskB --> Unlabeled
  Tok1 --> MaskB
  TokM["TokM"] --> MaskB
  end
  ...
  SQuAD --> E1'["E₁'"]
  SQuAD --> EM["EM'"]
  E["CLS"] --> Question["Question"]
  Question --> Paragraph["Paragraph"]
  Question --> AnswerPair["Question Answer Pair"]
```
</details>

Figure 1: Overall pre-training and fine-tuning procedures for BERT. Apart from output layers, the same architectures are used in both pre-training and fine-tuning. The same pre-trained model parameters are used to initialize models for different down-stream tasks. During fine-tuning, all parameters are fine-tuned. [CLS] is a specia symbol added in front of every input example, and [SEP] is a special separator token (e.g. separating questions/answers).
...
In this work, we denote the number of layers (i.e., Transformer blocks) as L, the hidden size as H, and the number of self-attention heads as A.<sup>3</sup> We primarily report results on two model sizes: BERT (L=12, H=768, A=12, Total Parameters=110M) and BERT (L=24, H=1024, A=16, Total Parameters=340M).
...
![](images/cd09bf2cf1935a39f918a6af34a0587866abe8d46d33304d83c8f60c0bda9869.jpg)  
...
<table><tr><td rowspan="2">System</td><td colspan="2">Dev</td><td colspan="2">Test</td></tr><tr><td>EM</td><td>F1</td><td>EM</td><td>F1</td></tr><tr><td colspan="5">Top Leaderboard Systems (Dec 10th, 2018)</td></tr><tr><td>Human</td><td>86.3</td><td>89.0</td><td>86.9</td><td>89.5</td></tr><tr><td>#1 Single - MIR-MRC (F-Net)</td><td>-</td><td>-</td><td>74.8</td><td>78.0</td></tr><tr><td>#2 Single - nlnet</td><td>-</td><td>-</td><td>74.2</td><td>77.1</td></tr><tr><td colspan="5">Published</td></tr><tr><td>unet (Ensemble)</td><td>-</td><td>-</td><td>71.4</td><td>74.9</td></tr><tr><td>SLQA+ (Single)</td><td>-</td><td></td><td>71.4</td><td>74.4</td></tr><tr><td colspan="5">Ours</td></tr><tr><td>BERT $_{LARGE}$  (Single)</td><td>78.7</td><td>81.9</td><td>80.0</td><td>83.1</td></tr></table>
...
<table><tr><td>System</td><td>Dev F1</td><td>Test F1</td></tr><tr><td>ELMo (Peters et al., 2018a)</td><td>95.7</td><td>92.2</td></tr><tr><td>CVT (Clark et al., 2018)</td><td>-</td><td>92.6</td></tr><tr><td>CSE (Akbik et al., 2018)</td><td>-</td><td>93.1</td></tr><tr><td colspan="3">Fine-tuning approach</td></tr><tr><td>BERT $_{LARGE}$ </td><td>96.6</td><td>92.8</td></tr><tr><td>BERT $_{BASE}$ </td><td>96.4</td><td>92.4</td></tr><tr><td colspan="3">Feature-based approach (BERT $_{BASE}$ )</td></tr><tr><td>Embeddings</td><td>91.0</td><td>-</td></tr><tr><td>Second-to-Last Hidden</td><td>95.6</td><td>-</td></tr><tr><td>Last Hidden</td><td>94.9</td><td>-</td></tr><tr><td>Weighted Sum Last Four Hidden</td><td>95.9</td><td>-</td></tr><tr><td>Concat Last Four Hidden</td><td>96.1</td><td>-</td></tr><tr><td>Weighted Sum All 12 Layers</td><td>95.5</td><td>-</td></tr></table>
...
Jeremy Howard and Sebastian Ruder. 2018. Universa language model fine-tuning for text classification. In ACL. Association for Computational Linguistics.  
...
Joseph Turian, Lev Ratinov, and Yoshua Bengio. 2010. Word representations: A simple and general method for semi-supervised learning. In Proceedings of the 48th Annual Meeting ofthe Associationfor Computational Linguistics, ACL ’10, pages 384–394.  
...
![](images/4cfe84a60a5fb0922c0b9cda90cf490d99dcdc4848aeac4cd21f455a8e4ceae4.jpg)  
...
$$
\begin{array}{r l} \text {Input} & = [ \text {CLS} ] \text {the man went to [MASK] store [SEP]} \\ & \text {he bought a gallon [MASK] milk [SEP]} \end{array}
$$

$$
\text {Label} = _ {\text {IsNext}}
$$

$$
\begin{array}{r l} \text {Input} & = [ \text {CLS} ] \text {the man [MASK] to the store [SEP]} \\ & \quad \text {penguin [MASK] are flight \#less birds [SEP]} \end{array}
$$

$$
\text {Label} = _ {\text {NotNext}}
$$
...
![](images/d1b9704c40d3d6c52afe65f2a93425e91b3acb19753827299306235961b21a04.jpg)
...
```mermaid
graph TD
  Input["Input Token"] -->|"Class Label"| BERT["BERT"]
  BERT -->|"E_CLS"| Token1["Token 1"]
  BERT -->|"E_1"| Token2["Token 2"]
  BERT -->|"E_N"| Token3["Token 3"]
  BERT -->|"E_SEP"| Token4["Token 4"]
  BERT -->|"E_1'"| Token5["Token 5"]
  BERT -->|"E_M"| Token6["Token 6"]
  Token1 -->|"Sentence 1"| Token1
  Token2 -->|"Sentence 2"| Token2
  Token3 -->|"Sentence 2"| Token3
  Token4 -->|"Sentence 2"| Token4
  Token5 -->|"Sentence 2"| Token5
  Token6 -->|"Sentence 2"| Token6
```
</details>

(a) Sentence Pair Classification Tasks: MNLI, QQP, QNLI, STS-B, MRPC, RTE, SWAG

![](images/1936e5eefb303c420a186eeb11b6cca6583b1ddd52fec3d594024ab4d0fe415e.jpg)
...
![](images/d40ea9833cbdd72d9f0277ae8e3b0874dfe375f80ccd3d4d38cceb1f1e1d1011.jpg)
...
graph TD
  ...
  E["&quot;E[CLS"]"] --> E1["E₁"]
  E1 --> ...((Output))
  Tok1["Tok 1"] --> Question["Question"]
  TokN["Tok N"] --> Question
  [SEP][SEP] --> Question
  Tok1 --> Paragraph["Paragraph"]
  TokM["Tok M"] --> Paragraph
  end
  ...
  Output["BERT"] --> StartEnd["Start/End Span"]

  %% Connections between nodes and arrows indicate directional relationships or dependencies within the model structure.
```
</details>

(c) Question Answering Tasks: SQuAD v1.1

![](images/bc8d329164259463ac3581b46a925390ad14921b9ee1ec879f30c062c2f28b92.jpg)
...
Answer: Yes, $\mathbf { B E R T _ { B A S E } }$ achieves almost 1.0% additional accuracy on MNLI when trained on 1M steps compared to 500k steps.
...
![](images/9fc5b295278a12c178beca64ce08b3fc7b01b58e9674b844459a4e108ec20e02.jpg)

<details>
<summary>line</summary>

| Pre-training Steps (Thousands) | BERT_BASE (Masked LM) | BERT_BASE (Left-to-Right) |
| --- | --- | --- |
| ~50 | ~78.6 | ~79.4 |
| ~100 | ~79.6 | ~79.9 |
| ~150 | ~80.6 | ~80.3 |
